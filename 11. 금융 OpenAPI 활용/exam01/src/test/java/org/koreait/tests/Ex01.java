...
public class Ex01 {
    ...
    void test1() throws Exception {
        ...
        // JSON 문자열 -> 자바 객체 변환
        RequestJoin form2 = om.readValue(json, RequestJoin.class); // 단일 클래스 형태의 자료형으로 변환 Class 클래스(class<T>)가 매개 변수이다.
        System.out.println("form2 : " + form2);
    }

    @Test
    void test2() throws Exception { // 변환시에 오류가 생길 수 있으니 Exception으로 예외 처리
    ...
    void test3() {
        ...
        UriComponents url = UriComponentsBuilder.fromUriString("https://www.naver.com")
                ...
                .queryParam("k3", "한글")
                .fragment("header")
                .encode() // 멀티 바이트 문자를 16진수 형태로 변경 - URL 인코딩
                .build();
        String _url = url.toString();
        System.out.println(_url); //queryParam 으로 구성된 주소를 가져옴
    }
