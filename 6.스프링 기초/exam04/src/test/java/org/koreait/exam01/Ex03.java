...
public class Ex03 {
   private Connection conn;
    ...
    void init() throws Exception {
        ...
        ds.setTimeBetweenEvictionRunsMillis(10 * 1000); // 10초 간격으로 유효 커넥션 연결 상태 체크 // 공통 기능
        ds.setMinEvictableIdleTimeMillis(50 * 1000); // 50초가 지난 유휴 객체 소멸, 새로 생성 // 공통 기능
        /* 커넥션 풀 설정 E */
    ...
    void test1() {
        try (Statement stmt = conn.createStatement()) {
            ...
            String sql = String.format("INSERT INTO MEMBER (SEQ, EMAIL, PASSWORD, USERNAME) " +
                        " VALUES (MEMBER_SEQ.nextval, '%s', '%s', '%s')", email, password,
                        userName);
    ...
    @Test
    @DisplayName("PraparedStatement 객체 생성 및 연습")
    void test2() {
